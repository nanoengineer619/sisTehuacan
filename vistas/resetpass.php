...
<html>
  <head>
    ...
    <title>Sistema de energia alectrica</title>
  ...
  <body class="hold-transition" style="background: #4B8A72;">
    <div class="login-box">
      <div class="login-logo">
        <h1 style="background: #4B8A72; color: white; width: 100%; text-align: center;">Sistema de Gestión Energética</h1>
